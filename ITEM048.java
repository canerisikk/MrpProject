public class ITEM048 extends ITEM1605 {
    ...
    public void Groos_Requirement2() {
        System.out.println(" ");
        System.out.println("FOR ITEM048");
        System.out.println("  ");
    ...
    public void TimePhased (){
        System.out.println("  ");
        hhh=new int[]{ bbb[3],bbb[4],bbb[5],bbb[6],bbb[7],bbb[8],bbb[9],0,0,0 };
        for(int i=0;i<10;i++){
    ...
    public void PlannedOrder (){
        System.out.println("  ");
        ööö=new int[]{ hhh[0],hhh[1],hhh[2],hhh[3],hhh[4],hhh[5],hhh[6],hhh[7],hhh[8],0 };
        for(int i=0;i<10;i++){
            if (hhh[i]!=0){
               if(bbb[i+3]%30==0){
                   ööö[i]=bbb[i+3];
               }else{
                   ööö[i]=(((bbb[i+3]/30)+1)*30);
               }
            }
    ...
    public void Delivery (){
        System.out.println("   ");
        sss=new int[]{ 0,0,0,ööö[0],ööö[1],ööö[2],ööö[3],ööö[4],ööö[5],ööö[6],ööö[7] };
        for(int i=0;i<10;i++){
