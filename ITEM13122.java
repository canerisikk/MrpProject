public class ITEM13122 extends ITEM1605{
    ...
    public void Groos_Requirement2() {
        System.out.println(" ");
        System.out.println("FOR ITEM13122");
        System.out.println("  ");
    ...
    public void TimePhased (){
        System.out.println("  ");
        hhh=new int[]{ bbb[1],bbb[2],bbb[3],bbb[4],bbb[5],bbb[6],bbb[7],bbb[8],bbb[9],0 };
        for(int i=0;i<10;i++){
    ...
    public void Delivery (){
        System.out.println("   ");
        sss=new int[]{ 0,ööö[0],ööö[1],ööö[2],ööö[3],ööö[4],ööö[5],ööö[6],ööö[7],ööö[8],ööö[9] };
        for(int i=0;i<10;i++){
